 ...
 */
final class Version20221102154645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD media_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8157AA0FEA9FDD75');
        $this->addSql('ALTER TABLE profile DROP media_id');
    }
}
